## Notes
## compile this file by source("cachevector.R")
...
test <-function() {
	message("Create test function voor make")
	vec <-makeVector(c(1,2,3,4,5,6))
	print("Before Caching")
	print("Value mean vector:")
	print(vec$getmean())
	print("Value vector mean", vec$getmean())
	cachemean(vec)
	print("After Caching")
	print("Value mean vector:")
	print(vec$getmean())
	print("Checking recaching value")
	cachemean(vec)
}